...
This environment is also where we can add additional dependencies, as usual. 
...
If you followed the [*Set-up guide*](http://localhost:8000/git/#setting_up_documenterjl) and added keys using DocumenterTools, your documentation is almost ready to go.
